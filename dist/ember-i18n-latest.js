...
(function() {
  var I18n, findTemplate, getPath, inlineFormatter, isBinding, isTranslatedAttribute, pluralForm;
  ...
  Handlebars.registerHelper('t', function(key, options) {
    ...
    Em.keys(attrs).forEach(function(property) {
      ...
      if (isBindingMatch && property !== 'contentBinding') {
  ...
  Handlebars.registerHelper("t_bind", function(property, options) {
    var view;
    options.hash.contentBinding = property;
    view = inlineFormatter(function(content) {
      return Ember.Handlebars.helpers.t.call(this, content, options);
    });
